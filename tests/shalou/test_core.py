...
def test_core():
    ...
    # [2026-09-13] 与沙漏权威测试对齐（本地源码库\shalou\tests\shalou\test_core.py）：
...
def test_integration():
    ...
    close_memory()
    import shutil
    shutil.rmtree(os.path.join(os.environ.get("CODEX_HOME", os.path.expanduser("~/.codex")), "shalou"), ignore_errors=True)
