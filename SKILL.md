...
| 维度 | 定义 |
|:----|:-----|
| 步骤 | ①收集本轮决策轨迹与自照报告 → ②审视执行模式：是否冗余重复？是否偏离初心？是否简洁高效？是否因主动冒险而获得了超额收益？如有，生成"勇气信号"，通过P6语义记忆给予正面加权，对冲纠偏偏好——勇气信号衰减采用半衰期式衰减：每轮剩余值 × 0.6（约每2轮减半），3轮后约剩10%，5轮后不足1%，自然归零 → ③生成方向校准信号 → ④归档至 Mindol codex → ⑤通过 P6 语义记忆静默影响下一轮裁决 |
